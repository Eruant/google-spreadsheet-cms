        ...
        app = {
            ...
            render: function (data) {
                ...
                if (this.rendered[data.url]) {
                    ...
                    this.rendered[data.url] = template; // save the output
                }
            ...
            initGadgets: function () {
                ...
                var items = document.querySelectorAll('.gadget'),
                    len = items.length,
                    i,
                    id,
                    gadget,
                ...
                for (i = 0; i < len; i += 1) {
                    item = this.codeStore[items[i].id];
                    gadget = new global[item.gadget](item.id, item.options);
                }
            },
            ...
            loadGadget: function (sheet, data) {
                ...
                if (data === 'all') {
                    ...
                    output = '<div id="' + dataset[data].id + '" class="gadget"></div>';
                    this.codeStore[dataset[data].id] = { gadget: sheet, id: dataset[data].id, options: { videoId: dataset[data].videoid }};
                } else {
